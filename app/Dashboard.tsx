...
const projectMaterials = [
  ...
  { id: "ina260", kit: "Kit de energía solar", quantity: "1", name: "INA260", specification: "Medición solar hasta 36 V/15 A; verificar Isc del panel", image: assetPath("materiales/ina260.png"), role: "Mide tensión, corriente y potencia del subsistema solar para mostrar producción, consumo y condiciones anómalas en el tablero web.", connection: "Se intercala en el conductor medido y comunica por I²C. Antes de instalarlo se verifica que la corriente de cortocircuito del panel nunca exceda la capacidad real del módulo y sus terminales." },
  { id: "pressure", kit: "Kit hidráulico", quantity: "1", name: "Sensor de presión", specification: "0–2 bar preferible o rango calibrable", image: assetPath("materiales/sensor-presion.png"), role: "Supervisa que la red opere dentro del rango de los microaspersores. Detecta falta de cebado, obstrucción, válvula cerrada y sobrepresión.", connection: "Se monta en una derivación del colector con sello apropiado. Su señal analógica se acondiciona al ADC y se contrasta con el manómetro durante la calibración." },
  { id: "flowmeter", kit: "Kit hidráulico", quantity: "1", name: "Caudalímetro Hall", specification: "Adecuado al rango real de 1–5 L/min", image: assetPath("materiales/caudalimetro.png"), role: "Cuenta el agua realmente entregada. Permite regar por volumen, detectar tuberías obstruidas o rotas y comprobar que la bomba respondió.", connection: "Se instala después del filtro y antes del colector de zonas, respetando la flecha de flujo. Su salida de pulsos se adapta a 3,3 V y se calibra mediante aforo." },
  ...
  { id: "oled", kit: "Control electrónico", quantity: "1", name: "Pantalla OLED", specification: "I²C, opcional para operación local", image: assetPath("materiales/pantalla-oled.png"), role: "Muestra localmente estado, nivel, batería, zona activa y alarmas durante instalación, mantenimiento o pérdida de conectividad.", connection: "Comparte el bus I²C, se alimenta a la tensión indicada por el módulo y se configura con una dirección que no entre en conflicto. No es necesaria para la autonomía." },
];
      ...
      <section className="section components-section" id="componentes">
        ...
        <div className="materials-catalog" aria-labelledby="materials-title">
          ...
          <div className="materials-stats" aria-label="Resumen del catálogo completo de materiales">
            <div><strong>24</strong><span>referencias ilustradas</span></div><div><strong>39</strong><span>piezas y sistemas</span></div><div><strong>6</strong><span>subsistemas integrados</span></div>
          </div>
